...
class FFXIVBenchmarkLauncher(QApplication):
  ...
  def build_cmdline(self):
    ...
    cmd_args = [
      ...
      "SYS.WaterWet=" + str(int(self.chk_wet_surface.isChecked())),
      "SYS.OcclusionCulling=" + str(int(self.chk_occlusion_culling.isChecked())),
      "SYS.LodType=" + str(int(self.chk_distance_lod.isChecked())),
      "SYS.ReflectionType=" + str(3 - self.cb_reflections.currentIndex()),
      "SYS.AntiAliasing=" + str(int(self.chk_fxaa.isChecked())),
      ...
      "SYS.ShadowTextureSizeType_DX11=" + str(int(self.chk_shadow_self.isChecked())),
